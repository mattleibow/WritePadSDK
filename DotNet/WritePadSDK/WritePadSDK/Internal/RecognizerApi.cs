...
namespace PhatWare.WritePad
{
    internal class RecognizerApi
    {
        ...
        [DllImport(Constants.LibraryName, EntryPoint = "HWR_GetLanguageID")]
        internal static extern Language HWR_GetLanguageID(IntPtr pRecognizer);

        [DllImport(Constants.LibraryName, EntryPoint = "HWR_GetLanguageName")]
        internal static extern IntPtr HWR_GetLanguageName(IntPtr pRecognizer);

        [DllImport(Constants.LibraryName, EntryPoint = "HWR_IsLanguageSupported")]
        internal static extern bool HWR_IsLanguageSupported(Language langID);

        [DllImport(Constants.LibraryName, EntryPoint = "HWR_GetSupportedLanguages")]
        internal static extern int HWR_GetSupportedLanguages(out IntPtr languages);


        // recognition API

        [DllImport(Constants.LibraryName, EntryPoint = "HWR_InitRecognizer")]
        ...
        [DllImport(Constants.LibraryName, EntryPoint = "HWR_InitRecognizerFromMemory")]
        ...
        [DllImport(Constants.LibraryName, EntryPoint = "HWR_FreeRecognizer")]
        ...
        [DllImport(Constants.LibraryName, EntryPoint = "HWR_RecognizerAddStroke")]
        internal static extern bool HWR_RecognizerAddStroke(IntPtr pRecognizer, InkTracePoint[] pStroke, int nStrokeCnt);

        [DllImport(Constants.LibraryName, EntryPoint = "HWR_Recognize")]
        internal static extern bool HWR_Recognize(IntPtr pRecognizer);

        [DllImport(Constants.LibraryName, EntryPoint = "HWR_Reset")]
        internal static extern bool HWR_Reset(IntPtr pRecognizer);

        [DllImport(Constants.LibraryName, EntryPoint = "HWR_RecognizeInkData")]
        ...
        [DllImport(Constants.LibraryName, EntryPoint = "HWR_SetDefaultShapes")]
        internal static extern bool HWR_SetDefaultShapes(IntPtr pRecognizer);

        [DllImport(Constants.LibraryName, EntryPoint = "HWR_SetLetterShapes")]
        internal static extern bool HWR_SetLetterShapes(IntPtr pRecognizer, IntPtr pShapes);

        [DllImport(Constants.LibraryName, EntryPoint = "HWR_GetLetterShapes")]
        internal static extern IntPtr HWR_GetLetterShapes(IntPtr pRecognizer);


        // external resource set function

        [DllImport(Constants.LibraryName, EntryPoint = "HWR_SetExternalResource")]
        ...
        internal static Language[] HWR_GetSupportedLanguages_Managed()
        {
            ...
            return Array.ConvertAll(languages, l => (Language)l); ;
        }
